...
// Initialize the database table
db2.serialize(() => {
    db2.run("CREATE TABLE cooking_tasks (id INTEGER PRIMARY KEY, order_id INTEGER, status TEXT)");
});
...
// Initialize the database table
db3.serialize(() => {
    db3.run("CREATE TABLE cooking_tasks (id INTEGER PRIMARY KEY, order_id INTEGER, status TEXT)");
});
